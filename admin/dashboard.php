...
$query1 = $db->query("SELECT SUM(total_price) FROM main_orders AS total WHERE delivery_status=1");
 $row1=$query1->fetch_assoc();
 $query1 = $db->query("SELECT * FROM main_orders WHERE delivery_status=1");
$count = mysqli_num_rows($query1);
$query2 = $db->query("SELECT * FROM main_orders WHERE delivery_status=0");
...
?>
			...
			<div class="row-fluid">
				...
				<div class="span3 statbox purple" onTablet="span6" onDesktop="span3">
					<div class="boxchart">5,6,7,2,0,4,2</div>
					<div class="number"><?php echo $row1['SUM(total_price)']; ?><i class="icon-arrow-up"></i></div>
					<div class="title">Sales</div>
					<div class="footer">
						<a href="sales.php"> read full report</a>
					</div>	
				</div>
				<div class="span3 statbox green" onTablet="span6" onDesktop="span3">
					<div class="boxchart">1,2,6,4,0,8,2</div>
					<div class="number"><?php echo $count+$count1; ?><i class="icon-arrow-up"></i></div>
					<div class="title">Total Orders</div>
					<div class="footer">
						<a href="totalorders.php"> read full report</a>
					</div>
				</div>
				<div class="span3 statbox blue noMargin" onTablet="span6" onDesktop="span3">
					<div class="boxchart">5,6,7,2,0,-4,-2</div>
					<div class="number"><?php echo $count; ?><i class="icon-arrow-up"></i></div>
					<div class="title">Delivered orders</div>
					<div class="footer">
						<a href="delivered.php"> read full report</a>
					</div>
				</div>
				<div class="span3 statbox yellow" onTablet="span6" onDesktop="span3">
					<div class="boxchart">7,2,2,2,1,-4,-2,4,</div>
					<div class="number"><?php echo $count1; ?><i class="icon-arrow-down"></i></div>
					<div class="title">Pending Orders</div>
					<div class="footer">
						<a href="pending.php"> read full report</a>
					</div>
				</div>	
