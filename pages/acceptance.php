	...
	<section>
		...
		<div class="extraPage">
			...
			<div class="paraBox">
				...
				<p>
				This policy is especially highlighted because we are introducing this policy for the very first time in Indian E-COMMERCE section. Most companies have Rejection Policies which state that the customer can reject their item if they find it inappropriate. But, we are saying, the customer shall accept the items only if he/she finds it appropriate. Our slogan is  &quotFirst satisfy yourself and then accept it&quot.
