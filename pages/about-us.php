...
<head>
	...
	<!-- SEO SECTION -->
		...
		<!-- Meta Ends -->
	<title>Veg Vendors-about us</title>
...
<body class="no-class footPages">
<div class="mainPage">

<?php

include ("vegvendorsHeaderLogo.php");
...
?>
	...
	<section>
		...
		<div class="extraPage">
			...
			<!-- PAGE HEADING -->
			<h1>About Veg Vendors</h1>

			<!-- FOR PARAGRAPH -->
			<div class="paraBox">
				<h2>Introduction</h2>
				<p>It is an on-demand delivery service that connects you to the nearest

vegetable hawkers. Veg Vendors aim is to amend the traditional way of

people buying groceries to make the local shopping experience more

convenient and amicable. We are substituting your visits to the nearby

vegetable hawkers with a few taps on the mobile/laptop/computer/tab.
				</p>
			</div>
			...
			<div class="paraBox">
				<h2>Little More</h2>
				<p>Lucidity and efficacy are the key drivers of our product and service. We

are introducing the <strong>“Acceptance Policy”</strong> for the very first time in Indian

E-Commerce section. Most companies have rejection policies which

state that the customer can reject their item if they find it inappropriate.

But, we are saying, the customer shall accept the items only if he/she

find it inappropriate.<br><br>
					This is a user-friendly site/app which provides easy surfing and also

offers easy modes of payments-Credit/Debit card, Cash on Delivery

(COD), E-wallet/paytm.<br><br>

					So, if you want fresh veggies on your doorstep, just #(company
