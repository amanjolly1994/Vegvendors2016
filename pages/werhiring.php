...
?>
	...
	<section>
		...
		<div class="extraPage">
			...
			<!-- PAGE HEADING -->
			<h1>Work For Vegvendors</h1>

			<!-- FOR PARAGRAPH -->
				<div class="background-hiring">
			...
			<div class="paraBox">
				<h2>We are hiring</h2>
				<p><b>Veg Vendors</b> is a unique platform which connects local vegetable 
vendors to the nearby customers in the course of its business.</br>We are looking for full stack developers, front-end & back-end, UX/UI designers skilled in web and mobile technologies.If you would like to work for us , You can send us your resume at <b>vegvendors@yahoo.com</b>.We are always glad to have you with us :).
...
<!-- FOR ANOTHER PARAGRAPH -->
			...
			<div class="paraBox">
				...
				<p><b>Veg Vendors<b><br><br>
			H.No 18, Basement, Pkt-4 & 5,
			Sector 23, Rohini, Delhi-110085<br><br>
			Tel.: +91 93 1300 1876<br><br>
			Email address: info@vegvendors.in
