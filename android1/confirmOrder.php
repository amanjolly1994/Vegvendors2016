<?php
//////////// wrong script by naman mahendru it is not used in rasan android script
	...
	if( $myarray != null )
	{
		$stmt = $db_con->prepare("INSERT INTO main_orders(uid,total_price,order_date) VALUES(:uid, :total_price,:order_date)");
