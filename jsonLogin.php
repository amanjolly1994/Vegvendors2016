...
<head>
	...
	<link rel="shortcut icon" href="localhost/favicon.png" />
	...
	<script src="/lang/js/controllers/selectLocation.js" charset="utf-8"></script>
	<script src="/lang/js/modals/setCookie.js" charset="utf-8"></script>
	<script src="/lang/js/controllers/fillArea.js" charset="utf-8"></script>
	<script src="/lang/js/modals/areaParser.js" charset="utf-8"></script>
	<script src="/lang/js/services/getJson.js" charset="utf-8"></script>
...
<body class="no-class common" onload="getJson()">
		...
		<div id="loginPage">
			...
			<div id="loginWrapper" class="hasShadow">
				<div id="loginBox">
					...
					<form action="/dummyHome" name="locationForm" id="locationForm" method="post" class="form-inline loginForm" enctype="multipart/form-data">

						<div class="catLoc">
					    <div class="form-group login-page-label">
					    ...
					    <div class="form-group sendingRight1">
					      <select id="areaSelect" required name="area" class="selectpicker" data-live-search="true" title="Please select your area">
							...
							<option id="clone-area" value="">Select your Area</option>
              ...
              <div class="clear"></div>
			 			...
			 			<div class="catLoc">
					    <div class="form-group login-page-label">
					      <label class="col-md-1 control-label" for="subarea">Sub-Area:</label>
					    </div>
					    <div class="form-group sendingRight2">
					      <select id="subAreaSelect" required name="subarea" class="selectpicker" data-live-search="true" title="Please select your Subarea">
					        <option id="clone-sub-area">Select area first</option>
              ...
              <div class="clear"></div>
					...
					<form class="loginForm" id="loginForm" method="post">
						...
						<a href="http://www.vegvendors.in/forgotPassword/"><p class="forgotPassword">forgot password?</p></a>
	...
	<section>
		<div class="rowApp">
			<div class="getApp">
				...
				<a href="localhost/pages/android.php"target="_blank"><img src="/theme/images/icons/74c874cf7dc5.png" /></a>
			</div>
		</div>
